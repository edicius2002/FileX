...
REGLAS_FIDELIDAD = ("I3", "I6", "I7", "I8", "V2", "V5", "V6", "V8", "V9",
                    "A4", "A5", "P2", "P6")
...
AYUDA = """Contrato de verificacion de FileX, en TRES grupos con presupuestos distintos.
  ...
  GRUPO C - FIDELIDAD (bajo demanda o en regresion; cuesta como convertir)
    ...
    Reglas I3/I6/I7/I8, V2/V5/V6/V8/V9, A4/A5, P2/P6 de referencia.json.
    ...
    con diferencia, la regla mas cara del grupo C.
