...
# Los venvs viven en la RAIZ del repositorio, no dentro del worktree: apuntar
# a "$ROOT/.venv-ai" daba rc=127 en las cuatro, en el mismo segundo, y el
# `return 0` de "seguir tras fallos" lo volvia silencioso. MEDIDO el 31/08.
VENVS=/d/Work/research/FileX
...
ejecutar() {
  ...
  "$VENVS/$entorno/Scripts/python.exe" "$OUT/b21b22.py" "$config" --ppp "$PPP" --reps 9 \
