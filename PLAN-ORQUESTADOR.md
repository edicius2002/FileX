...
- **El catálogo se paga en CADA TURNO: ×2,0–2,6 — MEDIDO** (`bench/saturacion-herramientas.md` §3.6 y §7.1, 540 ejecuciones). Un catálogo de 7.886 tokens costó **≈19.000–23.600 tokens de entrada por petición sencilla**; uno de 2.306, **≈8.800**; el intercambio típico fueron **2,1 turnos**. **Los ≤1.200 tokens del presupuesto son ≈2.400–3.100 tokens por petición**, y ese es el número que hay que comparar con el resto de la ventana.
