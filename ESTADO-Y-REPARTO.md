...
| **N28** | **Sobrepasar el bitrate CON audio no es evaluable**: 4 de 12 patológicas quedan declaradas, no atrapadas. Basta que `motores.FFmpeg` publique su `-b:a` en `decidido` | 🔴 **NUEVO** · `bitrate-y-lock.md` §2.5 |
