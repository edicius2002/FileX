...
| ~~**B19**~~ | ~~**`patologico_escaneado` NO discrimina**: **0,00 % en las 11 celdas de 8 de las 9 configuraciones, 88 celdas a cero**. Era uno de los tres documentos que B13 pedía barrer y **no sirve para caracterizar `k`**. Hay que sustituirlo en el corpus de barrido | 🔴 **NUEVO** · ídem |
