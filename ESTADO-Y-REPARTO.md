...
| Ruta | Para qué |
|---|---|
| `CLAUDE.md` | Las reglas de trabajo, las **123** trampas ya pagadas y las reglas de diseño no negociables. ~~24~~ — **la cifra llevaba setenta y ocho trampas desfasada**, que es el mismo defecto que esta sección viene a arreglar |
