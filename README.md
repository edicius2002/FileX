...
| **Modificar el código sin repetir errores ajenos** | [`CLAUDE.md`](CLAUDE.md) — las reglas de trabajo y las **122 trampas ya pagadas**, cada una con la medida que la respalda. Es el documento más útil del repositorio si vas a tocar algo |
