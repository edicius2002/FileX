...
| **Las reglas y las 119 trampas ya pagadas** | [`CLAUDE.md`](CLAUDE.md) — cada una con la medida que la respalda. Léelo ANTES de tocar nada: es el documento más útil del repositorio si vas a modificar código |
